...
const menuGroups = [
    ...
    },
    {
        title: "Management",
        items: [
            { name: "Users", icon: Users, href: "/customers" },
            { name: "Vendors", icon: Store, href: "/restaurants" },
            { name: "Delivery Partners", icon: Bike, href: "/riders" },
        ]
    },
    {
        title: "Operations",
    ...
    },
    {
        title: "Logistics",
        items: [
            { name: "Cities & Zones", icon: MapPin, href: "/logistics" },
        ]
    },
    {
        title: "Finance",
        items: [
            ...
            { name: "Commissions", icon: ShieldCheck, href: "/commissions" },
