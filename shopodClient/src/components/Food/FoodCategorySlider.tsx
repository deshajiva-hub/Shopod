            ...
            <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                {foodItems.map((item, i) => (
                    <div key={i} className="flex-shrink-0 w-32 flex flex-col items-center">
                        <div className="w-32 h-32 bg-blue-50 rounded-2xl flex items-center justify-center overflow-hidden mb-3 hover:shadow-lg transition-transform hover:-translate-y-1">
                            <img
                                src={item.img}
                                alt={item.name}
