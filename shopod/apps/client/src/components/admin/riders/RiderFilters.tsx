...
import { Search, Filter, X, ChevronDown, Bike } from "lucide-react";
...
export default function RiderFilters({ onSearch, onFilterChange }: RiderFiltersProps) {
    return (
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="relative flex-1">
                    ...
                    <input
                        type="text"
                        placeholder="Search by Partner Name or Phone Number..."
